...
static struct PazPackKey BlowFishKey_yorino_Pack[] = {
    {
        "bg.paz", 32, 0,
        {
            {
                0xC4, 0x9D, 0x2E, 0xD9, 0x6D, 0xF9, 0x84, 0xD4, 0xA9, 0x91, 0x1B, 0x78, 0x57, 0xCE, 0x12, 0x3B,
	            0x05, 0xB2, 0xC7, 0xCE, 0x35, 0xF5, 0x5C, 0x39, 0x5A, 0x09, 0x91, 0x36, 0x81, 0xE8, 0x6F, 0xE8
            },
            {
	            0xF2, 0x33, 0x36, 0xBB, 0x45, 0x4F, 0x39, 0x5A, 0x66, 0xE1, 0xE3, 0x32, 0x92, 0x5B, 0xCA, 0xFC, 
	            0x39, 0x0E, 0x1D, 0x25, 0xA4, 0xBF, 0x11, 0x19, 0xC5, 0xB3, 0xFC, 0x97, 0x69, 0xCB, 0xED, 0x19
            }
        }
    },
    {
        ...
        {
            {
	            0xCC, 0x17, 0x06, 0x07, 0x6E, 0x13, 0xAC, 0x8F, 0x40, 0xB9, 0xD6, 0xEE, 0x1D, 0x9F, 0x25, 0xF5, 
	            0x8B, 0x10, 0x8C, 0xF4, 0x84, 0x7D, 0x35, 0x3C, 0x5C, 0xA0, 0x85, 0x03, 0xD7, 0x7F, 0x48, 0x8F
            },
            {
	            0x7E, 0xFE, 0x37, 0x9A, 0xC9, 0x59, 0xF1, 0x90, 0x98, 0x1E, 0x98, 0x6E, 0xC6, 0xDE, 0xDA, 0x4C, 
	            0x71, 0x82, 0xE4, 0x8C, 0x09, 0x55, 0xA3, 0x05, 0xA2, 0x6D, 0x27, 0xB5, 0xED, 0x9A, 0x49, 0x05
            }
        }
    },
    {
        ...
        {
            {
	            0x70, 0x71, 0xFD, 0x82, 0xA1, 0x04, 0x83, 0xF6, 0x55, 0xC4, 0xB7, 0xCC, 0x8C, 0x06, 0x01, 0x65, 
	            0x51, 0x34, 0x8A, 0xAD, 0x79, 0xD0, 0xB8, 0x41, 0x04, 0x9D, 0x21, 0xD5, 0x45, 0x24, 0x3B, 0x07
            },
            {
	            0xA0, 0x3E, 0xC9, 0x20, 0x23, 0x8A, 0x55, 0x0F, 0x6C, 0xEF, 0xDE, 0xD5, 0xC4, 0x26, 0xE3, 0xE2, 
	            0xDF, 0xAC, 0x8D, 0x39, 0x0E, 0xCE, 0x8F, 0x40, 0x3A, 0x56, 0xCD, 0x40, 0x40, 0xB5, 0x22, 0x4E
            }
        }
    },
    {
        ...
        {
            {
	            0x7D, 0xA0, 0x00, 0x53, 0xF2, 0xBA, 0x25, 0x21, 0x19, 0x1D, 0xD4, 0x87, 0xD5, 0xB4, 0x75, 0xD1, 
	            0xEC, 0x32, 0x2A, 0x64, 0x63, 0xA3, 0xC8, 0xE4, 0x78, 0x1D, 0x04, 0xB7, 0x68, 0x12, 0xF0, 0x3E
            },
            {
	            0x1A, 0x3E, 0x61, 0x07, 0x8B, 0xD2, 0x12, 0x52, 0xCF, 0x08, 0x36, 0x14, 0x68, 0x1B, 0xEA, 0x75, 
	            0xEE, 0x77, 0x2F, 0x38, 0xC0, 0x8F, 0x7C, 0x31, 0xD7, 0x0C, 0x70, 0x59, 0x8E, 0x80, 0x67, 0x38
            }
        }
    },
    {
        ...
        {
            {
	            0x92, 0x5C, 0x1E, 0xD2, 0xBE, 0x00, 0x26, 0xEC, 0x3B, 0xAE, 0xF3, 0xBE, 0xBE, 0x30, 0xE6, 0xDA, 
	            0xF2, 0xB3, 0x41, 0x6A, 0x36, 0xA1, 0x73, 0xD0, 0x22, 0xA2, 0x25, 0x1F, 0xD0, 0x19, 0xC8, 0x64
            },
            {
	            0xDD, 0x06, 0xD3, 0x2E, 0x1F, 0x72, 0x2F, 0x63, 0x85, 0x4F, 0x99, 0xD8, 0x5A, 0x0A, 0x83, 0xFB, 
	            0xBC, 0x91, 0xEB, 0x08, 0x04, 0x82, 0xC3, 0x4B, 0x54, 0x3B, 0x41, 0x6D, 0xB2, 0x25, 0xCC, 0x31
            }
        }
    },
    {
        ...
        {
            {
	            0x6A, 0xB9, 0x66, 0xAB, 0xC7, 0x3D, 0xCB, 0xFC, 0xA3, 0x01, 0x10, 0x68, 0xF0, 0xF2, 0xB1, 0x1E, 
	            0x5D, 0xF3, 0xFB, 0x13, 0x83, 0xBF, 0xD9, 0xC1, 0xAE, 0x40, 0xE7, 0x94, 0x2E, 0xB4, 0xEF, 0xD0
            },
            {
	            0x8E, 0x19, 0xAA, 0x09, 0xD9, 0x90, 0xEE, 0xBB, 0x2B, 0x94, 0x95, 0xD9, 0xDE, 0x49, 0x6A, 0x1D, 
	            0xE6, 0x47, 0xB5, 0x27, 0x64, 0x78, 0xE4, 0x4B, 0x84, 0xA0, 0x66, 0xC4, 0x14, 0x63, 0x75, 0x36
            }
        }
    },
    {
        ...
        {
            {
	            0x88, 0x3A, 0xEB, 0x7D, 0x85, 0xC4, 0xB0, 0x0E, 0x8C, 0x66, 0x16, 0x9B, 0x49, 0x51, 0x4A, 0x1C, 
	            0x51, 0x3E, 0x2C, 0x22, 0x8D, 0xD6, 0xF7, 0x6B, 0x73, 0x79, 0x28, 0xF0, 0x40, 0xAE, 0x57, 0x85
            },
            {
	            0x6E, 0xA3, 0x3B, 0x42, 0xE1, 0x3F, 0x0C, 0x2D, 0xE9, 0x6C, 0x00, 0xD6, 0x93, 0x64, 0x62, 0x01, 
	            0x2D, 0xE7, 0xA7, 0x7F, 0xD0, 0x43, 0xBD, 0xB3, 0x18, 0x8C, 0x94, 0xE1, 0x64, 0xE6, 0x29, 0x1E
            }
        }
    },
    {
        ...
        {
            {
	            0x6D, 0x2A, 0x4E, 0x05, 0x61, 0xB7, 0xC6, 0xAC, 0x43, 0xC2, 0x4B, 0x15, 0x84, 0x4B, 0x38, 0x36, 
	            0xE9, 0x8A, 0xF8, 0x4E, 0xDD, 0x60, 0xA1, 0x61, 0x8D, 0x80, 0x1E, 0x75, 0x32, 0x49, 0x53, 0x14
            },
            {
	            0x7B, 0x40, 0xDC, 0x60, 0x95, 0x93, 0x3D, 0x78, 0x6E, 0x0D, 0xB0, 0xF4, 0xB3, 0x0E, 0x1C, 0x23, 
	            0x62, 0x04, 0x7D, 0xA4, 0x5E, 0xF5, 0x2D, 0xE9, 0x1F, 0xD4, 0xC1, 0xB4, 0xA7, 0xFD, 0x0A, 0x42
            }
        }
    },  
    {0, 0, 0, 0}
...
static GAMEDECRYPTINFO BlowFishKey_yorino = {
    "yorino", 0x8b, 2, vector<HANDLE>(), {"yM25L9uG", "59nffxSW", "7Ufuc6pX", "DbF5Svdf"}, BlowFishKey_yorino_Pack
};
